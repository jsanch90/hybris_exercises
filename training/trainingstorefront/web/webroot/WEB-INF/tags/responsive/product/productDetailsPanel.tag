...
<c:url value="${product.url}/update/myCreationDate" var="creationDatePath"/>

<div class="product-details page-title">
    <ycommerce:testId code="productDetails_productNamePrice_label_${product.code}">
        <div class="name">${fn:escapeXml(product.name)}<span class="sku">ID</span><span
                class="code">${fn:escapeXml(product.code)}
        </span>
        </div>
    </ycommerce:testId>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-details">
                        ...
                        <div>
                            <%--My Creation Date Form--%>
                            <form:form id="my-creation-date-form" method="post" modelAttribute="myCreationDateForm"
