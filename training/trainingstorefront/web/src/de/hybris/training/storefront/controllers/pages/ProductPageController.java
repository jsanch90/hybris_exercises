...
import de.hybris.training.facades.myCreationDate.MyCreationDateFacade;
...
public class ProductPageController extends AbstractPageController
{
	...
	@Resource(name = "myCreationDateFacade")
	private MyCreationDateFacade myCreationDateFacade;
	...
	//Custom RequestMapping for update my creation date.
	@ResponseBody
	@RequestMapping(value = PRODUCT_CODE_PATH_VARIABLE_PATTERN + "/update/myCreationDate", method = { RequestMethod.POST })
	public void updateMyCreationDate(final MyCreationDateForm myCreationDateForm) throws ParseException {
		myCreationDateFacade.setCreationDate(myCreationDateForm.getMyCreationDateFormInput(),myCreationDateForm.getProductCode());
	}
